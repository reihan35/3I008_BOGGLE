...
(*                         else *)
(*                             Iter.append solutions_via_voisins (Iter.singleton path_prime) *)
...
(*                  |false-> solutions_via_voisins;; *)
                 |false -> Iter.append (Iter.flat_map (fun x -> backtrack board lex_prime path_prime x) (Board.neighbours board (i, j))) (Iter.empty);;
